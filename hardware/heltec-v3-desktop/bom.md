# Bill of Materials — Heltec V3 Desktop Node
...
The Heltec V3 uses a **JST 1.25mm 2-pin** connector — not JST-PH (2.0mm). Verify before purchasing batteries or pigtails. Many generic LiPos ship with the wrong connector size.

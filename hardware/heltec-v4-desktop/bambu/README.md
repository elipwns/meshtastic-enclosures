# Print Files — Heltec V4 Desktop Node

Print files are published on MakerWorld, not stored in this repository.

## Get the Files

**MakerWorld listing:** [Meshtastic Enclosure — Heltec WiFi LoRa 32 Desktop Node (V3 + V4)](https://makerworld.com/en/models/2542854-meshtastic-enclosure-heltec-wifi-lora-32-v3#profileId-2799773)

<!-- TODO: Update link above once V4 plates are added to the listing -->
...
Each profile includes all four plates: `body`, `tray-v3`, `tray-v4`, and `lid`. Print the body and lid once — select only the tray for your board.

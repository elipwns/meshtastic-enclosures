# Meshtastic Config — Heltec V4 Desktop Node

Same setup as the V3 — the only difference is the firmware target. Select **Heltec WiFi LoRa 32 V4** in the flasher; everything else is identical.
...
3. Select device: **Heltec WiFi LoRa 32 V4**
...
The V4 has a small OLED display. For a desktop node left running, these settings help:
...
- **V3 vs V4 firmware:** Always verify you're flashing the correct variant — V3 and V4 firmware are not interchangeable
